...
public class irt extends PageObjects {
    public irt(WebDriver driver) {super(driver);}
...
//tela Consulta de Declaração Anual de Imposto sobre os Rendimentos do Trabalho
    ...
    By btnCriarDeclaracao    =  By.id("form-search:j_id_8e");

    public void setBtnCriarDeclaracao(){driver.findElement(btnCriarDeclaracao).click();}
...
//Ações após search
    ...
    ///modal irt-declaracao-anual-consulta ao clicar no btnCriarDeclaracao
     ...
     By btnConfirmar = By.id("j_id_94:j_id_ai");
     By btnVoltar    = By.id("j_id_94:j_id_aj");

        public void setBtnConfirmar(){driver.findElement(btnConfirmar).click();}
